            ...
            <!-- <li class="nav-item dropdown show">
                <a class="nav-link" data-toggle="dropdown" href="#" aria-expanded="true">
                    ...
                    <span class="badge badge-info navbar-badge">
                        //remember to add '?=' after the '<' before 'Cart'
                         //<Cart::countPeople() ?>
  ...
  <!-- Left side column. contains the sidebar -->
    ...
    <!-- Logo -->
      <a href="<?= SystemURLs::getRootPath() ?>/v2/dashboard" class="brand-link">
          ...
          <img src="<?= SystemURLs::getRootPath() ?>/Images/standlogo.png" alt="St. Andrews Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
